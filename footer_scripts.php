...
var moviesid = $(this).attr("data-moviesid");
var booking_for = $("#date").val();
var seats_available = parseInt($(this).attr("data-seats_available"));
if(package_id=="")
{
$("#package_id").focus();
$("#package_id").css('border','2px solid #ec000069');
$("#error3").text('Please Select Package');
return false;
}
$("#package_id").css('border','1px solid green');
if(no_of_seats<1)
{
$("#no_of_seats").focus();
...
method:'post',
data:{'no_of_seats':no_of_seats,'booking_for':booking_for,'package_id':package_id,'moviesid':moviesid,'book_ticket':1},
...
var date  = $(this).val();
var moviesid = $("#moviesid").attr("data-moviesid");
...
url : "movie_data.php",
method:"post",
data:{"new_date":date,"no_of_seats":no_of_seats,"moviesid":moviesid,"package_id":package_id},
success:function(data){
$("#show").html(data);
...
$("#book_ticket").attr("data-seats_available",$("option:selected", "#package_id").attr("data-package_limit"));
}
$("#show").on("change","#package_id",function(){
update_seats_available_button();
});
